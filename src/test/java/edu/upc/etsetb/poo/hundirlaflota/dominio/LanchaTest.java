...
public class LanchaTest extends ReductorTraza {
    ...
    public LanchaTest() {
        ...
        LanchaTest.indErrors = SuperClassForTests.indErrors;
    }
    ...
    public static void tearDownClass() {
        showErrors(indErrors, "LanchaTest");
        nota.put("LanchaTest", puntosTotales);
        puntosTotales = 0;
    }
    ...
    public void test01_constructor() {
        ...
        this.printlnAlways("\nComprobando Lancha::Lancha(..). Valor: " + valorTotal);
        try {
            String expectedNombre = "nombreLancha";
            int expectedLon = 1;
            Barco instance = new Lancha(expectedNombre);
