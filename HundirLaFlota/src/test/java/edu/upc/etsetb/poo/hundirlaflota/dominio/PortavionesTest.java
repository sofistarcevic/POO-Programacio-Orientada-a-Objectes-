...
public class PortavionesTest extends ReductorTraza {
    ...
    public PortavionesTest() {
        super();
        numInstances++;
        if (numInstances == 1) {
            numErrorsBefore = SuperClassForTests.indErrors.size();
        }
        PortavionesTest.indErrors = SuperClassForTests.indErrors;
    }
    ...
    public static void tearDownClass() {
        showErrors(indErrors, "PortavionesTest");
        nota.put("PortavionesTest", puntosTotales);
        puntosTotales = 0;
    }
    ...
    public void test01_constructor() {
        ...
        this.printlnAlways("\nComprobando Portaviones::Portaviones(..). Valor: " + valorTotal);
        try {
            String expectedNombre = "nombrePortaviones";
            int expectedLon = 5;
            Barco instance = new Portaviones(expectedNombre);
