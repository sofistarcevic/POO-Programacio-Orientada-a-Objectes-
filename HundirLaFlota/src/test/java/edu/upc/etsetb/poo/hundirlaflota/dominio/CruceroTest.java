...
public class CruceroTest extends ReductorTraza {
    ...
    public CruceroTest() {
        ...
        CruceroTest.indErrors = SuperClassForTests.indErrors;
    }
    ...
    public static void tearDownClass() {
        showErrors(indErrors, "CruceroTest");
        nota.put("CruceroTest", puntosTotales);
        puntosTotales = 0;
    }
    ...
    public void test01_constructor() {
        ...
        this.printlnAlways("\nComprobando Crucero::Crucero(..). Valor: " + valorTotal);
        try {
            String expectedNombre = "nombreCrucero";
            int expectedLon = 2;
            Barco instance = new Crucero(expectedNombre);
