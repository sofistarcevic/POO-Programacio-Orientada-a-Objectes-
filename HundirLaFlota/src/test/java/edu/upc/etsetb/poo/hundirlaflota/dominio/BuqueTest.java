...
public class BuqueTest extends ReductorTraza {
    ...
    public BuqueTest() {
        ...
        BuqueTest.indErrors = SuperClassForTests.indErrors;
    }
    ...
    public static void tearDownClass() {
        showErrors(indErrors, "BuqueTest");
        nota.put("BuqueTest", puntosTotales);
        puntosTotales = 0;
    }
    ...
    public void test01_constructor() {
        ...
        this.printlnAlways("\nComprobando Buque::Buque(..). Valor: " + valorTotal);
        try {
            String expectedNombre = "nombreBuque";
            int expectedLon = 4;
            Barco instance = new Buque(expectedNombre);
